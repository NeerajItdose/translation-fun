...
public class ShowMostRecentActivityTest {
  ...
  private void clickOnRecentButton() {
    ViewInteraction appCompatButton = onView(allOf(ViewMatchers.withId(R.id.btn_recent), withText("Show All"),
