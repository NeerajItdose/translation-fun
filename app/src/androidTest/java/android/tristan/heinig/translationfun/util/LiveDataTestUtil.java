package android.tristan.heinig.translationfun.util;
...
public class LiveDataTestUtil {
   ...
   * stop observing.
   */
  public static <T> T getValue(final LiveData<T> pLiveData) throws InterruptedException {
    final Object[] data = new Object[1];
    final CountDownLatch latch = new CountDownLatch(1);
    Observer<T> observer = new Observer<T>() {
      @Override
      public void onChanged(@Nullable T pObject) {
        data[0] = pObject;
        latch.countDown();
